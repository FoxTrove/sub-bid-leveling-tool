...
export function CommentNotificationEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>New comment on "{projectName}"</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            <strong>{commenterName}</strong> commented on <strong>"{projectName}"</strong>.
          </Text>
          ...
          <Text style={footer}>
            ...
            <br />
            You received this because you own or are shared on this project.
          </Text>
        </Container>
      </Body>
    </Html>
