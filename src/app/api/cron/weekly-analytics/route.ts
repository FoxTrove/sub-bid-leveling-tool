...
const ADMIN_EMAILS = ['kyle@foxtrove.ai', 'admin@bidlevel.com']
...
function buildWeeklyReport(
  ...
  lines.push('BIDLEVEL WEEKLY ANALYTICS REPORT')
  ...
  lines.push('='.repeat(60))
  lines.push('Report generated by BidLevel Analytics System')
