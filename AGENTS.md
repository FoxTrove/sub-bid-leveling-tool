...
**API Key Management**: Standard users start with 5 signup credits. HANDSHAKE partner users get 30 days of fully covered partner access, then continue with their own encrypted OpenAI key.

### Database Tables (Supabase)

- `profiles` - User data, signup credits, promo/partner tracking, encrypted API keys
...
```typescript
SIGNUP_BONUS_CREDITS = 5, FREE_COMPARISON_LIMIT = 5
HANDSHAKE_FREE_PERIOD_DAYS = 30
MAX_FILE_SIZE = 25MB
